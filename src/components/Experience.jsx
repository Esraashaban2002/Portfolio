...
import digiliansLogo from '../assets/images/helwan-university-logo.png';
import webMastersLogo from '../assets/images/web masters.jpg';
import sefAcademyLogo from '../assets/images/web masters.jpg';
  ...
  const experiences = [
    {
      ...
      technologies: ['React.js', 'Node.js', 'MongoDB', 'Express.js', 'Git', 'GitHub'],
    ...
    },
    {
      ...
      location: 'Remote',
      locationType: 'Remote',
      technologies: ['React.js', 'JavaScript', 'Git', 'GitHub', 'REST APIs'],
      challenge: language === 'ar'
